...
// If debugging is enabled, if any of the specified bits are set in the debugFlagMask,
...
// The flags parameter is either a single bit value (1/2/4/8/16/etc), or more than one value
